...
** Note: The identity for hpcloud is something fucking the same now as of 1.5.0-beta-whateverthefuck which is "tenantName:userName" and the credential is "userPassword"
