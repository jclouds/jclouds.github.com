...
| o.j.p/cloudfiles-uk| blobstore| sdk-support @t rackspace.com | [90/99](/documentation/releasenotes/1.5.0/cloudfiles-uk.txt)| [failures](/documentation/releasenotes/1.5.0/cloudfiles-uk-failures.txt) test needs update for more containers|
| o.j.p/cloudfiles-us| blobstore| sdk-support @t rackspace.com | [91/96](/documentation/releasenotes/1.5.0/cloudfiles-us.txt)| [failures](/documentation/releasenotes/1.5.0/cloudfiles-us-failures.txt) expires header is returned by server, but swift ObjectToBlobMetadata doesn't action that.|
...
| o.j.p/cloudservers-uk| compute| sdk-support @t rackspace.com | [110/154](/documentation/releasenotes/1.5.0/cloudservers-us.txt)| [failures](/documentation/releasenotes/1.5.0/cloudservers-us-failures.txt) error in test
| o.j.p/cloudservers-us| compute| sdk-support @t rackspace.com | [131/152](/documentation/releasenotes/1.5.0/cloudservers-us.txt)| [failures](/documentation/releasenotes/1.5.0/cloudservers-us-failures.txt)
...
| o.j.p/rackspace-cloudservers-us| compute| sdk-support @t rackspace.com | [113/125](/documentation/releasenotes/1.5.0/rackspace-cloudservers-us.txt)| [failures](/documentation/releasenotes/1.5.0/rackspace-cloudservers-us-failures.txt)|
...
| o.j.a/cloudfiles| blobstore| unassigned | sdk-support @t rackspace.com | pending| |
| o.j.a/cloudservers| compute| unassigned | sdk-support @t rackspace.com | pending| |
